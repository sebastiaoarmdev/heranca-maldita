...
monogatari.translation ('Português', {
	'AdvanceHelp': 'Você pode avançar no jogo usando o botão esquerdo do mouse, clicando em qualquer lugar na tela do jogo ou pressionar a barra de espaço.',
	'AllowPlayback': 'Clique aqui para permitir a reprodução de áudio',
	'Audio': 'Áudio',
	'AutoPlay': 'Automatizar',
	...
	'OK': 'OK',
	'OrientationWarning': 'Por favor, gire o dispositivo para jogar',
	...
	'SaveInSlot': 'Salvar no espaço',
	'SelectYourLanguage': 'Selecione seu idioma',
	'Settings': 'Ajustar',
	'SettingsButton': 'Abrir Tela de Ajustar',
	'Show': 'Exibir',
	'Skip': 'Pular',
	'SkipButton': 'Pular automático',
	'SlotDeletion': 'Deseja excluir este jogo?',
	'SlotOverwrite': 'Deseja substituir este jogo?',
	'Sound': 'Volume do Som',
	'Start': 'Iniciar',
	'Stop': 'Parar',
	'TextSpeed': 'Velocidade do Texto',
	'Video': 'Volume do Vídeo',
	'Voice': 'Volume de Voz',
	'Windowed': 'Em Janela'
});

monogatari.languageMetadata ('Português', {
    code: 'pt', 
    icon: 'br'
});